namespace :deploy do
  ...
  task :production do
    ...
    puts "clearing cache"
    system "echo 'Rails.cache.clear' | heroku run console -a roydon-cedar"
  ...
  task :staging do
    ...
    puts "clearing cache"
    system "echo 'Rails.cache.clear' | heroku run console -a roydon-staging"
    puts "Refreshing missing attachments"
  ...
  task :development do
    ...
    puts "clearing cache"
    system "echo 'Rails.cache.clear' | heroku run console -a roydon-dev"
    puts "Refreshing missing attachments"
